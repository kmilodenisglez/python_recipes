...
def optimize(infile, format="jpg"):
    runString = {
    ...
    if format in runString:
        sp = subprocess.Popen(runString[format] % {'file': infile}, shell=True)
        sp.wait()
...
if __name__ == "__main__":
    ...
    # olp = r"C:\Users\zoro\Downloads\prueba_un2x3\jpegoptim-1.4.6\testing\2.jpg"
    # optimize(olp)
